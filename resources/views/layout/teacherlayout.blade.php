                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top bg-dark ">
                                ...
                                <ul class="navbar-nav flex-column mt-4">
                                    <li class="nav-item">
                                        <a href="/dashboard-teacher" class="nav-link text-white p-3 mb-2 current">
                                            <i class="fa fa-home text-light fa-lg mr-3"></i>Home
                                        </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a href="/teacher" class="nav-link text-white p-3 mb-2 sidebar-link">
                                            <i class="fas fa-chalkboard-teacher text-light fa-lg mr-3"></i>Teachers
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="/matkul" class="nav-link text-white p-3 mb-2 sidebar-link"">
                                            <i class="fa fa-book text-light fa-lg mr-3"></i>Subjects
                                        </a>
                                    </li>
                                    {{-- <li class="nav-item">
